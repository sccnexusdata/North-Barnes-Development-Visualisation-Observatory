const visualRules = {
  ...
  1:{detail:'Illustrative access, drainage, utilities corridors and construction activity begin. Exact engineering locations remain unresolved.',show:['enabling']},
  ...
  5:{detail:'A second neighbourhood appears alongside early school/community provision and maturing green infrastructure.',show:['enabling','phase1','phase2','school']},
  10:{detail:'Roughly half of the illustrative build-out is present. The local centre, employment and sports provision become more substantial.',show:['enabling','phase1','phase2','phase3','school','centre','employment','sports']},
  15:{detail:'Additional neighbourhoods fill out the internal structure while parks, wetland planting and green corridors continue to mature.',show:['enabling','phase1','phase2','phase3','phase4','school','centre','employment','sports','green']},
  20:{detail:'Most of the illustrative housing and currently described commercial/employment quantum is present, with later plots still incomplete.',show:['enabling','phase1','phase2','phase3','phase4','phase5','school','centre','employment','sports','green']},
  25:{detail:'Illustrative completion at the current maximum of 3,000 homes, with the published school, health, sports, employment and green-space components represented.',show:['enabling','phase1','phase2','phase3','phase4','phase5','phase6','school','centre','employment','sports','green','health']}
};

const fallbackPhases = [0,1,3,5,10,15,20,25].map(year => ({
  year,
  label: ({0:'Existing landscape',1:'Enabling works',3:'First neighbourhood',5:'Early community',10:'Settlement takes shape',15:'Maturing town',20:'Late build-out',25:'Minimum plausible completion'})[year],
