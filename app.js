const visualRules = {
  ...
  10:{detail:'Roughly half of the illustrative build-out is present. Commercial, employment and sports elements are scenario representations; detailed quantities remain subject to source confidence.',show:['enabling','phase1','phase2','phase3','school','centre','employment','sports']},
  15:{detail:'Additional illustrative neighbourhoods fill out the internal structure while parks, wetland planting and green corridors continue to mature.',show:['enabling','phase1','phase2','phase3','phase4','school','centre','employment','sports','green']},
  ...
  25:{detail:'Illustrative completion at the current maximum of 3,000 homes. School and broad employment/green-space principles have primary support; detailed commercial, employment, health, sports and named-facility representations remain source-qualified in the evidence model.',show:['enabling','phase1','phase2','phase3','phase4','phase5','phase6','school','centre','employment','sports','green','health']}
};
