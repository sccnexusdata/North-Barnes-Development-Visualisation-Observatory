const CACHE='north-barnes-observatory-v19';
const CORE=['./','index.html','verification.html','privacy.html','LICENSE.txt','styles.css','app.js','experience.js','proposal-overlay.js','site.webmanifest','data/phasing-model.json','data/viewer-config.json','data/claim-review.json','data/proposal-preview.geojson','assets/aerial-study.svg','assets/black-cap-study.svg','assets/icon.svg'];
const RELEASE_SENSITIVE=new Set(['styles.css','app.js','experience.js','proposal-overlay.js','site.webmanifest','data/phasing-model.json','data/viewer-config.json','data/claim-review.json','data/proposal-preview.geojson','data/release.json']);
